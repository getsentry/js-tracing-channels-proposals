...
_Snapshot 2026-06-16 · weekly npm downloads · denominator = whole tracked ecosystem, all versions (827.5M/wk). Numerator counts only downloads on channel-capable versions (real adoption, not “exists upstream”)._

| | Channel-capable / ecosystem | Coverage |
|---|---|---|
| **Without Sentry** (undici, fastify, pino, h3, srvx, unstorage, nitro) | 236.9M / 827.5M | **28.6%** |
| **With Sentry** (+ mysql2, redis, ioredis, mongoose, graphql, ai) | 246.6M / 827.5M | **29.8%** |
| **Sentry's effect (adopted today)** | +9.7M | **+1.2 pts** |

**Fair single statement:** Sentry has merged native tracing into libraries representing **~13% of the ecosystem's weekly downloads** (the ceiling at full adoption); **~1.2 points is adopted in production today**, with the rest landing as users upgrade.
...
| Vercel AI (Node) | `ai` | ~58M | `packages/node/src/integrations/tracing/vercelai/` | [ai#14410](https://github.com/vercel/ai/issues/14410) | [ai#15660](https://github.com/vercel/ai/pull/15660) (Vercel-driven) | ✅ **Merged** (2026-06-15) — prerelease only (v7.0.0-beta.178; stable v6 line pending). Ships `ai:telemetry` TracingChannel |
