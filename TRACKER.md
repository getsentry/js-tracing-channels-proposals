...
_Snapshot 2026-06-11 · weekly npm downloads · denominator = whole tracked ecosystem, all versions (737.0M/wk). Numerator counts only downloads on channel-capable versions (real adoption, not “exists upstream”)._

| | Channel-capable / ecosystem | Coverage |
|---|---|---|
| **Without Sentry** (undici, fastify, pino, h3, srvx, unstorage, nitro) | 215.6M / 737.0M | **29.2%** |
| **With Sentry** (+ mysql2, redis, ioredis, mongoose, graphql) | 224.0M / 737.0M | **30.4%** |
| **Sentry's effect (adopted today)** | +8.4M | **+1.1 pts** |

**Fair single statement:** Sentry has merged native tracing into libraries representing **~12% of the ecosystem's weekly downloads** (the ceiling at full adoption); **~1.1 points is adopted in production today**, with the rest landing as users upgrade.
